function initMap (){
    map = new ymaps.Map("yandexmap_contactspage", {
...
var elemantwo = document.getElementsByClassName('submit-button-orderacall-contacts')[0];
elemantwo.setAttribute("disabled", true);
var checkboxtwo = document.querySelector('.custom-checkbox-orderacall');    
